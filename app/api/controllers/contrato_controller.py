from app.api.services.contrato_services import get_contratos, get_contrato_by_id, get_contrato_detalle, crear_contrato, eliminar_contrato

def get_all_contratos():
    return get_contratos()

def get_contratoDetail(id: int):
    return get_contrato_detalle(id)
